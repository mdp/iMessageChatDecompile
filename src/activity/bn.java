...
{
  bn(NewMessageActivity paramNewMessageActivity)
  {
  }
  ...
  public final void onItemClick(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    case 1:
      ...
      this.a.startActivityForResult(localIntent2, 69634);
      return;
    case 2:
      ...
      try
      {
        this.a.startActivityForResult(Intent.createChooser(localIntent1, this.a.b.getString(2131165258)), 69632);
        return;
      }
    ...
    NewMessageActivity.h(this.a).setVisibility(8);
    NewMessageActivity.i(this.a).setVisibility(0);
  }
}

/* Location:           /Users/mdp/Downloads/iMessage/classes-dex2jar.jar
 * Qualified Name:     activity.bn
